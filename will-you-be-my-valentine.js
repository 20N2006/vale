let messages = ["Please?", "Give me a chance!", "Are you sure?", "Think again!", "You might regret this!", "One last chance!", "Seriussnih?", "Yaudahh Dehh 💔"];
let noCount = 0;
...
function acceptLove() {
    document.getElementById("valentine").innerHTML = `
        ...
        <div class="question">YAYAYYAYAYAYAY THANK YOU, HAPPY VALENTINE'S DAY❤️</div>
    `;
    launchConfetti();
    startHeartRain();
}
